...
public class FlickrFetchr {
    ...
    private static final String API_KEY = "b35229a84426f9f302004efa131ea45f";
    ...
    {
        JSONObject photosJsonObgect = jsonBody.getJSONObject("photos");
        JSONArray photoJsonArray = photosJsonObgect.getJSONArray("photo");
